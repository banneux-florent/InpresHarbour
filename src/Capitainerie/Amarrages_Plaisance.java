 ...
 * @author Florent & Wadi
 */
public class Amarrages_Plaisance extends javax.swing.JDialog {

    
    public Amarrages_Plaisance(LinkedList<Ponton> pontons) {
        initComponents();
        ...
        for (int i = 0; i < pontons.size(); i++) {
            for (int j = 0; j < pontons.get(i).getListe(1).length; j++) {
                ...
                if (tempBateauPlaisance != null) {
                    tableModel.addRow(new Object[]{pontons.get(i).getIdentifiant(), "Droite (1)", j, tempBateauPlaisance.getNom(), tempBateauPlaisance.getPortAttache()});
                } else {
                    tableModel.addRow(new Object[]{pontons.get(i).getIdentifiant(), "Droite (1)", j, "", ""});
                }
            }
            for (int j = 0; j < pontons.get(i).getListe(2).length; j++) {
                tempBateauPlaisance = (BateauPlaisance) pontons.get(i).getListe(2)[j];
                if (tempBateauPlaisance != null) {
                    tableModel.addRow(new Object[]{pontons.get(i).getIdentifiant(), "Gauche (2)", j, tempBateauPlaisance.getNom(), tempBateauPlaisance.getPortAttache()});
                } else {
                    tableModel.addRow(new Object[]{pontons.get(i).getIdentifiant(), "Gauche (2)", j, "", ""});
                }
            }
        }
    ...
    private void initComponents() {
        ...
        setTitle("Liste des amarrages de plaisance (pontons)");
        setResizable(false);
        ...
        jLabel12.setText("Liste des amarrages de plaisance (pontons)");
